...
At `Mark 1`, scopes are created

```
diagram 1: to be added
```

At `Mark 2`, player is created

```
diagram 2: to be added
```

At `Mark 3`, player scope (with player instance) is disposed

```
diagam 3: to be added
```
