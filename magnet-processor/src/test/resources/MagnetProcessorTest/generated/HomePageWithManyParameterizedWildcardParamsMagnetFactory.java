...
public final class HomePageWithManyParameterizedWildcardParamsMagnetFactory implements InstanceFactory<Page> {
    @Override
    ...
    public Page create(Scope scope) {
        ...
        return new HomePageWithManyParameterizedWildcardParams(variant1, variant2, variant3, variant4);
    }
